...
class TextProcessor:
    def __init__(self):
        ...
        self.ordinals = {
            ...
            40: "fortieth", 50: "fiftieth", 60: "sixtieth", 70: "seventieth", 80: "eightieth",
            90: "ninetieth",
        }
        self.units = {
        ...
        self.symbols = {
            '%': 'percent', '@': 'at', '&': 'and', '+': 'plus',
            '=': 'equals', '/': 'per', '#': 'number', '*': 'asterisk',
            '°': 'degrees', '§': 'section', '¶': 'paragraph', '©': 'copyright',
            '®': 'registered', '™': 'trademark'
        }

        # Letter-number prefix mappings
        self.letter_prefixes = {
            'Q': 'Quarter', 'P': 'Phase', 'V': 'Version', 'Ch': 'Chapter',
            'Fig': 'Figure', 'Sec': 'Section', 'App': 'Appendix', 'Vol': 'Volume',
            'Pg': 'Page', 'Rev': 'Revision', 'ID': 'ID', 'No': 'Number',
            'Ref': 'Reference'
        }
